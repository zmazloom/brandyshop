...
import com.brandyshop.domain.srv.response.Response;
...
public class LogUtils {
    ...
    private static AdditionalExtra getLines() {
        ...
        List<StackTraceElement> projectTraces = filterNoneProjectTraces(lineFinder.getStackTrace());
        return new AdditionalExtra("lines", ModelUtils.toString(projectTraces));
    }
    ...
    private static List<StackTraceElement> filterNoneProjectTraces(StackTraceElement[] stackTrace) {
        List<StackTraceElement> result = new ArrayList<>();
        String className;
        for (StackTraceElement element : stackTrace) {
            className = element.getClassName();
            if (className.startsWith("com.brandyshop"))
                result.add(element);
        }
        return result;
    }
